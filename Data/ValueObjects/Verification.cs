...
namespace Data.ValueObjects
{
    internal class Verification : ValueObject
    {
        ...
        {
            DomainExceptionValidation.When(IsActive, "This code have already verified");
            DomainExceptionValidation.When(ExpireAt > DateTime.UtcNow, "This code have already expired");
